        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrinkState = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineDrinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MachineDrinks_Drinks_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MachineDrinks_Machines_MachineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionUserInfoInJson = table.Column<string>(nullable: true),
                    MachineDrinkId = table.Column<long>(nullable: true),
                    MachineId = table.Column<int>(nullable: true),
                    ShortChange = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MachineId = table.Column<int>(nullable: true),
                    CoinState = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineDrinks_DrinkId",
                table: "MachineDrinks",
                column: "DrinkId");

            migrationBuilder.CreateIndex(
                name: "IX_MachineDrinks_MachineId",
                table: "MachineDrinks",
                column: "MachineId");
